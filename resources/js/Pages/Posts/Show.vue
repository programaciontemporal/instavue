<script setup>
import AppLayout from '@/layouts/AppLayout.vue'; // Corregido
                    ...
                    <div class="p-6">
                        ...
                        <div class="comments-section">
                            ...
                            <div v-if="post.comments && post.comments.length > 0">
                                <div v-for="comment in post.comments" :key="comment.id" class="mb-2 flex items-start">
                                    <Link :href="route('profile.show', comment.user.id)" class="flex-shrink-0 mr-3">
                                        <Avatar class="size-8 overflow-hidden rounded-full border border-gray-200 dark:border-gray-700">
                                            <AvatarImage :src="comment.user.avatar_url" :alt="comment.user.name" class="object-cover w-full h-full" />
                                            <AvatarFallback class="rounded-full bg-neutral-200 font-semibold text-black dark:bg-neutral-700 dark:text-white text-xs">
